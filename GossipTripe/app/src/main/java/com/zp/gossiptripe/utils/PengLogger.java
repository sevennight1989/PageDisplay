...
public class PengLogger implements  Runnable {
    ...
    private static String LOGM_PATH_SDCARD_DIR = "/sdcard"+File.separator +"gossip"+File.separator+ "Log/";// 日志文件在sdcard中的路径
    private static int SDCARD_LOG_FILE_SAVE_DAYS = 0;// sd卡中日志文件的最多保存天数
    private static String LOGMFILEName = "Log.txt";// 本类输出的日志文件名称

    private static PengLogger instance = null;
    ...
    public synchronized static PengLogger getInstance() {
        if (instance == null) {
            instance = new PengLogger();
        }
        return instance;
    }
